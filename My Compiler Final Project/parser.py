# ===== parser.py =====
"""
Recursive-descent parser that builds an AST. Import tokenize from lexical.
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 parser.py sample.src"); sys.exit(1)
